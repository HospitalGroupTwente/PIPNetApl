...
def eval_pipnet(net,
    ...
    for i, (xs, ys) in test_iter:
        ...
        with torch.no_grad():
            ...
            #print(f"max_out_score: {max_out_score}")
            #print(f"ys_pred: {ys_pred}")
            ys_pred_scores = F.softmax((torch.log1p(out**net.module._classification.normalization_multiplier)),dim=1)[:,1]
            #print(f"prediction scores: {ys_pred_scores}")
